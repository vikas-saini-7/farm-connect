    ...
    <header className="bg-gradient-to-r from-green-50 to-emerald-50 shadow-sm border-b border-emerald-100 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
        ...
        <div className="space-x-4 hidden md:flex items-center">
          <Link href="/login">
            <button className="group relative inline-flex items-center justify-center overflow-hidden rounded-lg border border-emerald-300 px-6 py-2 font-medium text-emerald-700 transition hover:shadow-lg hover:border-emerald-400">
          ...
          <Link href="/signup">
            <button className="group relative inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-emerald-500 to-teal-500 px-6 py-2.5 text-white font-semibold shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-[1.03]">
