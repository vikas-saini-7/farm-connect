...
//     'Pune', 'Mumbai', 'Bangalore', 'Jaipur',
//     'Delhi', 'Ahilyanagar', 'Nashik', 'Indore',
//     'Surat', 'Ahmedabad', 'Nanded', 'Latur', 'Beed', 'Buldhana', 'Dharashiv', 'Jalna',
//     'Sambhajinagar', 'Thane', 'Ratnagiri', 'Dhule', 'Jalgaon', 'Satara',
//     'Sangli', 'Solapur', 'Kolhapur', 'Nagpur'
//   ];
...
//       if (!formData.email || !formData.phone || !formData.location || formData.categories.length === 0) {
...
//       const payload = {
//         email: formData.email,
//         phone: formData.phone,  // Will be mapped to contactNumber in backend
//         location: { 
//           title: formData.location 
//         },
//         categories: formData.categories,
//         role: role === 'buyer' ? 'Buyer' : 'Seller', // Ensure proper capitalization
//         ...(formData.hasCertificate && formData.certificate && {
//           certificate: {
//             title: formData.certificate.title,
//             issuedBy: formData.certificate.issuedBy,
